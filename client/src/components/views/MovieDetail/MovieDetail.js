...
function MovieDetailPage(props) {
    ...
    useEffect(() => {
        ...
        let endpointForMovieInfo = `${API_URL}movie/${movieId}?api_key=${API_KEY}&language=pt-BR`;
        ...
        <div>
            ...
            <div style={{ width: '85%', margin: '1rem auto' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem' }}>
                    <Button onClick={toggleActorView}>Alternar para visualização de atores </Button>
                </div>
